...
Les deje una carpeta con todos los CSV y SQL (los SQL no me dieron errores para agregarlos manualmente, no las dejé insertadas por el simple echo de que serían unas 4000 líneas de código) creados en Mackroo, para tener algunas tablas las ingrese manualmente asi poder probar la funcionalidad del proyecto.
